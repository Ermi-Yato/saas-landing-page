        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
          <FeatureCard title="Real-time Collaboration" description="Work together seamlessly with conflict-free team editing" className="md:col-span-2 lg:col-span-1">
            <div className="aspect-video flex items-center justify-center">
              ...
              <Avatar className="border-transparent -ml-6">
                <div className="size-full rounded-full bg-neutral-700 flex gap-1 items-center justify-center">
                  {arr.map((_, index) => (
          ...
          <FeatureCard title="Keyboard Quick Actions" description="Powerfull commands to help you create designs more quickly" className="md:col-span-2 md:col-start-2 lg:col-span-1">
            <div className="aspect-video flex gap-4 items-center justify-center font-medium">
              <div className="px-10 py-3 rounded-2xl bg-neutral-300 inline-flex text-neutral-950 "><span>shift</span></div>
              <div className="px-4 py-3 rounded-2xl bg-neutral-300 inline-flex text-neutral-950 "><span>alt</span></div>
              <div className="px-6 py-3 rounded-2xl bg-neutral-300 inline-flex text-neutral-950 "><span>C</span></div>
            </div>
          </FeatureCard>
        </div>
